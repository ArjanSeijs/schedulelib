...
execute as @e[distance=..20] run function schedulelib:api/schedule_command_ctx {command : 'say 4 Sec', time: "4s"}
execute as @e[distance=..20] run function schedulelib:api/schedule_function_ctx {function : 'schedulelib:tests/say', time: "5s", args: {arg1:"5s...",arg2:10}}
