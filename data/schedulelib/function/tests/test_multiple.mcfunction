...
function schedulelib:api/schedule_command {command : 'say 3 Sec', time: "3s"}
function schedulelib:api/schedule_function {function : 'schedulelib:api/schedule_command', time: "1s", args: {command : 'say 4 Sec []', time: "3s"}}